...
namespace Vigeo.Test.Test20240417 {
     ...
     */
        ...
        private bool IsAnyOrbitKeyPressed() =>
        ...
        void Rotate() {
            ...
            if (Input.GetMouseButton(0) || IsAnyOrbitKeyPressed() || (Input.touchCount == 1 && Input.touches[0].phase == TouchPhase.Moved)) {
                ...
                if (Input.GetMouseButton(0)) {
                    xDeg += Input.mousePositionDelta.x * xSpeed * Time.deltaTime * 0.1f;
                    yDeg -= Input.mousePositionDelta.y * ySpeed * Time.deltaTime * 0.1f;
                }
        ...
        void Zoom() {
            ...
            if (Input.GetKey(KeyCode.LeftBracket)) {
                // Find the difference in the distances between each frame.
                deltaMagnitudeDiff = -25;
            }
            if (Input.GetKey(KeyCode.RightBracket)) {
                deltaMagnitudeDiff = 25;
            }
            if (Input.mouseScrollDelta.magnitude != 0) {
                deltaMagnitudeDiff = Input.mouseScrollDelta.y * zoomRate;
            }
            ...
            if (Math.Abs(desiredDistance - currentDistance) > 0.1f) {
